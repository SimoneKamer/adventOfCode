...
public class BathroomLockDecoderTest {
    ...
    @Test
    public void secondExample() {assertThat(decoder.findBathroomCode("ULL\nRRDDD"),is("19"));}

    @Test
    public void thirdExample() {assertThat(decoder.findBathroomCode("ULL\nRRDDD\nLURDL"),is("198"));}
    ...
    public void actualDirections() {
        assertThat(decoder.findBathroomCode("\n" +
